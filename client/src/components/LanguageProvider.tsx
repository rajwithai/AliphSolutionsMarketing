...
const translations = {
  en: {
    ...
    'tier1.description': 'Access 1,000+ Saudi-specific templates, policies, and toolkits curated by the Aliph Brain — instantly, anytime.',
  ...
  ar: {
    ...
    'tier1.description': 'احصل على أكثر من 1000 قالب وسياسة وأداة خاصة بالسعودية منسقة بواسطة عقل أليف — فورًا في أي وقت.',
